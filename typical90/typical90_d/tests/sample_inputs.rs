...
"#)
        .tee_output()
        .expect_success();
    assert_eq!(output.stdout_str(), r#"5 5 5
5 5 5
5 5 5
"#);
...
"#)
        .tee_output()
        .expect_success();
    assert_eq!(output.stdout_str(), r#"28 28 25 26
39 33 40 34
38 38 36 31
41 41 39 43
"#);
...
"#)
        .tee_output()
        .expect_success();
    assert_eq!(output.stdout_str(), r#"627 629 598 648 592 660 567 653 606 662
...
"#)
        .tee_output()
        .expect_success();
    assert_eq!(output.stdout_str(), r#"1479 1471 1546 1500 1518 1488 1551 1466 1502 1546
