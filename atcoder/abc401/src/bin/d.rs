...
fn f(n: usize, k: usize, mut s: Vec<char>) -> Vec<char> {
    ...
    {
        s2
    } else if s.iter().filter(|&&c| c == 'o').count() == k {
        s.iter()
            .map(|&c| if c == '?' { '.' } else { c })
            .collect::<Vec<_>>()
    } else {
...
mod tests {
    ...
    fn test_name_2() {
        assert_eq!(
            f(1, 1, "?".chars().collect_vec()),
            "o".chars().collect_vec()
        );
        assert_eq!(
            f(1, 0, "?".chars().collect_vec()),
            ".".chars().collect_vec()
        );
        assert_eq!(
            f(1, 1, "o".chars().collect_vec()),
            "o".chars().collect_vec()
        );
        assert_eq!(
            f(1, 0, ".".chars().collect_vec()),
        ...
        assert_eq!(
            f(5, 3, "?????".chars().collect_vec()),
            "o.o.o".chars().collect_vec()
        );

        assert_eq!(
            f(5, 2, "??.??".chars().collect_vec()),
            "??.??".chars().collect_vec()
        );
        assert_eq!(
            f(5, 2, ".?.??".chars().collect_vec()),
    ...
    fn test_name_44() {
        ...
        assert_eq!(
            f(7, 2, ".??o??.".chars().collect_vec()),
            ".?.o.?.".chars().collect_vec()
        );
        assert_eq!(
            f(7, 2, ".??o?o.".chars().collect_vec()),
            "...o.o.".chars().collect_vec()
        );
    }
